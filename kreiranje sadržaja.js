...
// Boldaj "kreiranje sadržaja" po defaultu
document.addEventListener("DOMContentLoaded", function () {
  var kreiranjeLink = document.querySelector(".Kreiranjesadržaja");
  if (kreiranjeLink) {
    kreiranjeLink.classList.add("Kreiranjesadržaja-bold");
  }
...
// klik da me odvede na copy.html
